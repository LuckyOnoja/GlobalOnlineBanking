    ...
    <div className="flex h-screen bg-gray-50">
      ...
      <div className="w-64 bg-white border-r border-gray-200">
        ...
        <nav className="mt-6">
          ...
          <Link href="/users" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 hover:bg-gray-50">
            <Users size={18} />
            <span>Users</span>
          </Link>
          <Link href="/transactions" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 hover:bg-gray-50">
            <ArrowUpDown size={18} />
          ...
          <div className="px-4 mt-6 mb-2">
            <p className="text-xs font-medium text-gray-400 uppercase tracking-wider">Administration</p>
          </div>
          <Link href="/settings" className="flex items-center gap-3 px-4 py-3 text-sm font-medium text-gray-600 hover:bg-gray-50">
            <Wallet size={18} />
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="flex items-center justify-between px-6 py-4">
            <div className="flex items-center gap-4">
              <h2 className="text-xl font-semibold text-gray-800">Propeneer Dashboard</h2>
            </div>
            <div className="flex items-center gap-6">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} />
                <input type="text" placeholder="Search..." className="pl-10 pr-4 py-2 rounded-lg border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" />
              </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">{accountStats.totalBalance}</h3>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">{accountStats.totalUsers}</h3>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">{accountStats.monthlyGrowth}</h3>
                </div>
              </div>
            </div>
            <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">{accountStats.pendingApprovals}</h3>
                </div>
              </div>
            </div>
          </div>
